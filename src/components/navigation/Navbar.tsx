  ...
  return (
    ...
    >
      <Container size="xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex lg:hidden items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-xl text-[#1F1B2D] hover:text-[#6D57A5] bg-[#FAF8FC] border border-[#E9E4F1] focus-ring-purple"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 pt-4 pb-6 px-4 bg-white border border-[#E9E4F1] rounded-2xl backdrop-blur-2xl shadow-xl animate-in fade-in slide-in-from-top-4 duration-200">
