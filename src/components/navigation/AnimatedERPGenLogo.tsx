...
export const AnimatedERPGenLogo: React.FC<AnimatedERPGenLogoProps> = ({
  ...
  return (
    <Link
      ...
      className="relative flex items-center justify-start focus-ring-purple rounded-lg p-1 transition-transform active:scale-95 shrink-0 group cursor-pointer select-none min-w-[170px] sm:min-w-[195px] lg:min-w-[205px] h-10 sm:h-11 lg:h-11"
    ...
    >
      ...
      <div className="hidden lg:flex items-center relative w-full h-full">
        ...
        <img
          ...
          draggable={false}
          className={`h-10 sm:h-11 lg:h-[42px] w-auto max-w-[200px] sm:max-w-[230px] lg:max-w-[225px] object-contain transition-all duration-500 ease-in-out select-none ${
            isDesktopBlueLogo
